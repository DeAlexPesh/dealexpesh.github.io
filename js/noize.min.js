var NoizeGen = (function() {
  ...
  var sndNoize01, bufNoize01, sndGane01, sndNoize02, bufNoize02, request, sndGane02;
  ...
  function NoizeGen(elId) {
    ...
    var bufSize02 = 2048;
    bufNoize02 = ACON.createBuffer(1, bufSize02, ACON.sampleRate); 
    request = new XMLHttpRequest();
    request.open("GET", "sound/sh2.mp3", true);
    request.responseType = "arraybuffer";
    request.onload = function() {
      ACON.decodeAudioData(request.response, function(b) {
        bufNoize02 = b;
      });
    }
  };
