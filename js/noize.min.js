var NoizeGen = (function() {
  ...
  NoizeGen.prototype.start = function (fps) {
    ...
    if ('null' != loopId) {
      ...
      if (!!ACON) {
        makeNoizeSnd();
        sndGane01.gain.value = 1.0;
        sndGane01.gain.exponentialRampToValueAtTime(0.01, ACON.currentTime);
        sndNoize01.start(0.1);
        sndGane02.gain.value = 0.01;
        sndGane01.gain.exponentialRampToValueAtTime(1.0, ACON.currentTime);
